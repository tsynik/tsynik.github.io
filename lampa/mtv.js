	...
	function startfreetv_n() {
		...
		Lampa.Listener.follow('app', function(r) {
			if (r.type == 'ready') {
				...
				var menu_items = $('<li class="menu__item selector" data-action="freetv_r"><div class="menu__ico">' + ico + '</div><div class="menu__text">Free.ТВ</div></li>');
	...
	function startkuliktv_n() {
		...
		Lampa.Listener.follow('app', function(r) {
			if (r.type == 'ready') {
				...
				var menu_items = $('<li class="menu__item selector" data-action="tvtv_r"><div class="menu__ico">' + ico + '</div><div class="menu__text">Кulik.ТВ</div></li>');
				menu_items.on('hover:enter', function() {
					Lampa.Activity.push({
						url: 'http://cdn.kulik.uz/tv/fed.json',
						title: 'Основные',
