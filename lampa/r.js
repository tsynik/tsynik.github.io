...
(function () {
  ...
  var menu_icon_alt='<svg enable-background="new 0 0 716.7 524" viewBox="0 0 716.7 524" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#eee" stroke-miterlimit="133.3333" stroke-width="50"><path d="m596.4 27.6c58.9 60.1 95.3 142.5 95.3 233.3 0 91.9-37.2 175.2-97.4 235.5m-469.3 2.6c-61.7-60.5-100-144.8-100-238.1 0-92.1 37.4-175.6 97.9-235.9" stroke-linecap="round" stroke-linejoin="round"/><path d="m501.2 129.1c35.4 33.8 57.2 80.2 57.2 131.3 0 51.7-22.3 98.5-58.4 132.5m-281.7 1.4c-37-34-60-81.5-60-133.9 0-51.9 22.4-98.8 58.7-132.7" stroke-linecap="round" stroke-linejoin="round"/><path d="m413.5 209.3c29.9 21.9 44.8 32.9 44.8 51.6s-14.9 29.7-44.8 51.6c-8.2 6.1-16.4 11.8-23.9 16.5-6.6 4.2-14.1 8.5-21.8 12.7-29.8 16.3-44.7 24.5-58 15.4-13.4-9-14.6-27.9-17-65.7-.7-10.7-1.1-21.2-1.1-30.6s.4-19.9 1.1-30.6c2.4-37.8 3.6-56.7 17-65.7s28.3-.9 58 15.4c7.7 4.2 15.2 8.5 21.8 12.7 7.5 5 15.7 10.7 23.9 16.7z"/></g></svg>'
  Lampa.Lang.add({
    radio_title: {
      ru: "Радио SomaFM",
      en: "SomaFM Radio",
