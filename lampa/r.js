...
(function () {
  ...
  var menu_icon = '<svg version="1.1" id="radio" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 53.3 48" enable-background="new 0 0 53.3 48" xml:space="preserve"><path fill="none" stroke="#EEEEEE" stroke-width="5.3333" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10.6667" d="M45.3,2.7H18.7c-2.5,0-3.7,0-4.7,0.3C11.2,3.7,9,5.8,8.3,8.6C8,9.6,8,10.9,8,13.4 M8,13.4c0.8-0.1,1.9-0.1,3.2-0.1h30.9c3,0,4.5,0,5.6,0.6c1,0.5,1.8,1.3,2.3,2.3c0.6,1.1,0.6,2.6,0.6,5.6v14.9c0,3,0,4.5-0.6,5.6c-0.5,1-1.3,1.8-2.3,2.3c-1.1,0.6-2.6,0.6-5.6,0.6H11.2c-3,0-4.5,0-5.6-0.6c-1-0.5-1.8-1.3-2.3-2.3c-0.6-1.1-0.6-2.6-0.6-5.6V21.9c0-3,0-4.5,0.6-5.6c0.5-1,1.3-1.8,2.3-2.3C6.2,13.6,7,13.4,8,13.4z M32,24h10.7 M32,34.7h10.7 M21.3,29.3c0,2.9-2.4,5.3-5.3,5.3s-5.3-2.4-5.3-5.3S13.1,24,16,24S21.3,26.4,21.3,29.3z"/></svg>'
  Lampa.Lang.add({
    radio_title: {
      ru: "Радио SomaFM",
      en: "SomaFM Radio",
