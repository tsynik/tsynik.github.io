...
(function () {
  ...
  var menu_icon = '<svg enable-background="new 0 0 53.3 48" viewBox="0 0 53.3 48" xmlns="http://www.w3.org/2000/svg"><path d="m45.3 2.7h-26.6c-2.5 0-3.7 0-4.7.3-2.8.7-5 2.8-5.7 5.6-.3 1-.3 2.3-.3 4.8m0 0c.8-.1 1.9-.1 3.2-.1h30.9c3 0 4.5 0 5.6.6 1 .5 1.8 1.3 2.3 2.3.6 1.1.6 2.6.6 5.6v14.9c0 3 0 4.5-.6 5.6-.5 1-1.3 1.8-2.3 2.3-1.1.6-2.6.6-5.6.6h-30.9c-3 0-4.5 0-5.6-.6-1-.5-1.8-1.3-2.3-2.3-.6-1.1-.6-2.6-.6-5.6v-14.8c0-3 0-4.5.6-5.6.5-1 1.3-1.8 2.3-2.3.6-.4 1.4-.6 2.4-.6zm24 10.6h10.7m-10.7 10.7h10.7m-21.4-5.4c0 2.9-2.4 5.3-5.3 5.3s-5.3-2.4-5.3-5.3 2.4-5.3 5.3-5.3 5.3 2.4 5.3 5.3z" style="fill:none;stroke:#eee;stroke-width:5.3333;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10.6667"/></svg>'
  Lampa.Lang.add({
    radio_title: {
      ru: "Радио SomaFM",
      en: "SomaFM Radio",
