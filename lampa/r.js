...
(function () {
  ...
  function Info(station) {
    ...
    function updatePlayingInfo(playingTrack) {
      ...
      var album_svg = album_info.find('svg');
			album_info.text(playingTrack.album ? playingTrack.album : '');
      playingTrack.album ? album_svg.toggleClass('hide', false) : album_svg.toggleClass('hide', true);
			info_html.find('.somafm-cover__title').text(playingTrack.title || '');
    ...
    this.create = function () {
      ...
      img_elm.src = station.xlimage; // image - 120 | largeimage - 256 | xlimage 512
