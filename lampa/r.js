...
(function () {
  ...
  var logo_menu = '<svg fill="none" width="800" height="800" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g stroke="#eeeeee" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="m17 5h-10c-3 0-5 2-5 5v7c0 3 2 5 5 5h10c3 0 5-2 5-5v-7c0-3-2-5-5-5z"/><path d="m7 2v3"/><path d="m8.5 16c1.38071 0 2.5-1.1193 2.5-2.5s-1.11929-2.5-2.5-2.5-2.5 1.1193-2.5 2.5 1.11929 2.5 2.5 2.5z"/><path d="m14.5 11h4"/><path d="m14.5 15h.5"/><path d="m18 15h.5"/></g></svg>'
  Lampa.Lang.add({
    radio_title: {
      ru: "Радио SomaFM",
      en: "SomaFM Radio",
