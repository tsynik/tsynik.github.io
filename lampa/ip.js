(function () {
    ...
    function createIPMenu() {
        window.plugin_ip_m_ready = true;
        Lampa.Component.add("ip_m", ip_m);
    ...
    if (!window.plugin_ip_m_ready) createIPMenu();
})();
