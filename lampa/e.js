	...
	function startexit_n() {
		...
		Lampa.Listener.follow('app', function(r) {
			if (r.type == 'ready') {
				...
				var menu_items = $('<li class="menu__item selector" data-action="freetv_r"><div class="menu__ico">' + ico + '</div><div class="menu__text">Lampa.Lang.translate('exit_menu')</div></li>');
//				if (Lampa.Storage.field('platform') == 'android') {
